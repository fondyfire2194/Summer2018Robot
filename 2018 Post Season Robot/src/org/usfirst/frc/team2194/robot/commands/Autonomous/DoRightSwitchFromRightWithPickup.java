 ...
 *
 */
public class DoRightSwitchFromRightWithPickup extends CommandGroup {

	public DoRightSwitchFromRightWithPickup() {
		// Add Commands here:
		...
		// addSequential(new SetDriveStraightAngle(angleTarget));
