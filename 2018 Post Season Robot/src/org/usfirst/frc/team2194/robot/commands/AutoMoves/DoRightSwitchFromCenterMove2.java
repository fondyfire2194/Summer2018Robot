 ...
 *
 */
public class DoRightSwitchFromCenterMove2 extends CommandGroup {

	public DoRightSwitchFromCenterMove2() {
		...
		addSequential(new RobotOrient(-DistCon.LSW_CA, DistCon.LSW_C_ORIENT_RATE, true, 2));

		addSequential(new SetDriveStraightAngle(-DistCon.LSW_CA));
		addSequential(new DriveToPosition(DistCon.LSWC_2 - 5, motionType.absolute, DistCon.SHORT_POSITION_RATE, false,
				false, 3));
		...
		addSequential(new PositionToSwitchWall(DistCon.LSWC_3, DistCon.SHORT_POSITION_RATE, 2));
