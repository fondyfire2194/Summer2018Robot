 ...
 *
 */
public class DoLeftSwitchFromLeftMove extends CommandGroup {

	public DoLeftSwitchFromLeftMove() {
		...
		/*
		 * 
		 * drive forward until opposite switch then turn 90 degrees cw and run into
		 * switch wall
		 * 
		 */
		...
		addSequential(new DriveToPosition(DistCon.LR_SW_1, motionType.absolute, DistCon.LONG_POSITION_RATE, false, false,3));

		addSequential(new RobotOrient(90, DistCon.ORIENT_RATE, true, 1.5));
