 ...
 *
 */
public class OuttakeCube extends CommandGroup {

	public OuttakeCube(double speed) {

		addSequential(new TurnWheelsToEjectOneShot());
		addSequential(new TimeDelay(.5));
		addSequential(new TurnIntakeWheels(0));
