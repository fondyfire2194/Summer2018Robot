...
public class DoLeftSwitchFromLeftWithPickup extends CommandGroup {
	...
	public DoLeftSwitchFromLeftWithPickup() {
		...
		addSequential(new RobotOrient(DistCon2.LRSW_A2, DistCon.ORIENT_RATE, driveSide.both, true, 2));
		addSequential(new ResetEncoders());
		addSequential(new SetDriveStraightAngle(DistCon2.LRSW_A2));
		// advance behind cube
		//addSequential(new DriveToPosition(DistCon2.LRSW_TO_CUBE, motionType.absolute, DistCon.LONG_POSITION_RATE, true, 3));
